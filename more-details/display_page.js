...
const hostelCards = document.querySelector('.js-more-details')
...
const phoneNumberLink = document.querySelector('.js-phone-number-link');

const managementWhatsappNumber = document.querySelector('.js-whatsapp-number');
const whatsAppNumber = document.querySelector('.js-whatsApp-number-link');

const managementEmailAddress = document.querySelector('.js-email-address');
const emailAddress = document.querySelector('.js-email-address-link');
...
hostels.forEach((hostel) => {
        if(hostelId === hostel.id){
            ...
            phoneNumberLink.href += hostel.contact.phone;
        
            managementWhatsappNumber.textContent = hostel.contact.whatsapp;
            whatsAppNumber.href += hostel.contact.email;

            managementEmailAddress.textContent = hostel.contact.email;
            emailAddress.href += hostel.contact.email;
