...
export function renderSugestedTyping(){
  ...
  input.addEventListener('input', function() {
      ...
      // Filter the hostelCardData array to only include hostels whose names contain the typed value
      const filtered = hostelCardData.filter(hostel => 
  ...
  searchButton.addEventListener('click', () => {
    ...
    hostelCardData.forEach((hostel) => { 
      ...
      if(gender && minUserPrice && maxUserPrice){
        if(hostel.type === gender && hostel.price >= minUserPrice && hostel.price <= maxUserPrice){
          hostelFilteredData += `
            <div class="hostel-card">
              <div class="image-container">
                  <img id="hostel-card-image" src="${hostel.image}" alt="hostel-image">
      ...
      }else if(hostel.type === gender || hostel.price >= minUserPrice && hostel.price <= maxUserPrice){
      // hostelFilteredData = '';
      hostelFilteredData += `
        <div class="hostel-card">
          <div class="image-container">
